...
const std::string ServiceController::USER_LOCAL_SERVICE = "NT AUTHORITY\\LocalService";
const std::string ServiceController::USER_LOCAL_SYSTEM = "NT AUTHORITY\\LocalSystem";
...
//
///////////////////////////////////////////////////////////////////////////////
bool ServiceController::Uninstall( const std::string& serviceName, std::chrono::seconds maxWaitTime ) const
{
	bool result = false;
...
//
///////////////////////////////////////////////////////////////////////////////
bool ServiceController::Stop( const std::string& serviceName, std::chrono::seconds maxWaitTime ) const
{
	bool result = false;
